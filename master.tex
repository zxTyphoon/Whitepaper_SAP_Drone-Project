...
\TitelDerArbeit{Exploring Voice-Controlled Drone Technology: PoC Development for SAP Labs India}
...
\input{textPages/introduction}
\cleardoublepage

\input{textPages/implementation.tex}
\cleardoublepage

\input{textPages/conclusion.tex}
\cleardoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
